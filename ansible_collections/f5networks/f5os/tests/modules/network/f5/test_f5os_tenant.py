...
class TestManager(unittest.TestCase):
    ...
    def test_tenant_update(self, *args):
        ...
        assert mm.client.put.call_count == 2
        assert mm.client.put.call_args_list[0][0][0] == '/f5-tenants:tenants/tenant=foo/config/vlans'
        assert mm.client.put.call_args_list[1][0][0] == '/f5-tenants:tenants/tenant=foo/config/running-state'
        assert mm.client.put.call_args_list[0][1] == {'data': {'vlans': [333, 444]}}
        assert mm.client.put.call_args_list[1][1] == {'data': {'running-state': 'deployed'}}
