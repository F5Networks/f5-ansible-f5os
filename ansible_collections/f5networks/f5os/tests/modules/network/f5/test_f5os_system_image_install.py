...
class TestManager(unittest.TestCase):
    ...
    def test_system_image_version_exist(self, *args):
        ...
        # {"f5-utils-file-transfer:output": {"entries": [{"name": "F5OS-A-1.8.0-14139.R5R10.CANDIDATE.iso", "date": "string", "size": "string"}]}}
    ...
    def test_system_image_install(self, *args):
        ...
        mm = ModuleManager(module=module)
        mm.client.platform = 'rSeries Platform'
        get_data = {'f5-system-image:output': {'response': 'System ISO version has been set.\\nEstimated time: 11 minutes\\nReboot(s): 1'}}
        get_data2 = {
            "f5-system-image:install": {
                "install-os-version": "1.8.0-14138",
                "install-service-version": "1.8.0-14138",
                "install-status": "success"
            }
        }
